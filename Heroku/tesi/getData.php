...
$results = pg_query($db_conn, "SELECT uknown, goal, wall, mapname FROM robotmap WHERE id = $id");

$check_numb_table = pg_query($db_conn, "SELECT * FROM robotmap");
